...
The implementation is written from scratch in TensorFlow 2.x and is **not** based on any
existing SRGAN code. Only the architecture and methodology are reproduced from the paper.
